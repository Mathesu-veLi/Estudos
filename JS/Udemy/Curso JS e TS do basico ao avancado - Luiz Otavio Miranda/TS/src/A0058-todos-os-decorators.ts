...
// Propriedade
function decoradorDePropriedade(prototipoDaClasse: any, nomePropriedade: string): any {
...
function decoradorDePropriedadeEstatica(classConstructor: any, nomePropriedade: string): any {
...
export class UmaPessoa {
    ...
    static metodoEstatico(@decoradorDeParametroDeMetodoEstatico msg: string): string {
